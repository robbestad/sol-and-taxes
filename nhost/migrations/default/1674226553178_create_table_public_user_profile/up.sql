CREATE TABLE "public"."user_profile" ("user_id" uuid NOT NULL, "wallet_address" text NOT NULL, "credits" integer NOT NULL DEFAULT 300, "credits_used" integer NOT NULL DEFAULT 0, "created_at" timestamptz NOT NULL DEFAULT now(), "updated_at" timestamptz NOT NULL DEFAULT now(), PRIMARY KEY ("user_id") , FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON UPDATE cascade ON DELETE cascade);
