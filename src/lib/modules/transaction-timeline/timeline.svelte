<script lang="ts">
  import TimelineDivider from './timeline-divider.svelte';
    ...
    <li>
      <div class="relative pb-8">
        ...
        <div class="relative flex items-start space-x-3">
          <div class="relative">
            <div
              class="flex w-10 items-center justify-center rounded-full bg-white ring-0"
            >
              <TimelineDivider extraClasses="text-gray-500" />
            </div>
          </div>
          <TransactionsBlock />
        </div>
        ...
        <div class="relative flex items-start space-x-3">
          ...
          <div class="min-w-0 flex-1 py-1.5">
            <div class="text-sm text-gray-500">
              <a
                href="#"
                class="font-medium text-gray-900">Hilary Mahy</a
              >
              assigned
              <a
                href="#"
                class="font-medium text-gray-900">Kristin Watson</a
              >
          ...
          <div class="min-w-0 flex-1">
            <div>
              <div class="text-sm">
                <a
                  href="#"
                  class="font-medium text-gray-900">Jason Meyers</a
                >
              </div>
